...
#define AC_FENCE_ACTION_GUIDED                      5       // guided mode, with target waypoint as fence return point
#define AC_FENCE_ACTION_GUIDED_THROTTLE_PASS        6       // guided mode, but pilot retains manual throttle control
